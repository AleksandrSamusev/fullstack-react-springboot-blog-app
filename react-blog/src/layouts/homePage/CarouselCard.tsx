export const CarouselCard = () => {
    return (
        <div className='container p-5 shadow shadow-lg' style={{border: '1px solid #E4E5EA', borderRadius: '10px'}}>
            <div className='row'>
                <div className='col p-3 m-auto '>
                    <h1 className='mb-3 mt-3' style={{fontFamily: 'Tahoma', fontSize: '40px'}}>Curiosity Rover Mission
                        Overview</h1>

                    <p style={{fontFamily: "Arial", fontSize: '18px', opacity: 0.8}} className="mt-5" >Part of NASA's Mars Science Laboratory mission,
